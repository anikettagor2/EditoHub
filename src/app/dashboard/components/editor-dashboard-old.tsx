                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 w-full lg:w-auto">
                    <div className="relative w-full sm:w-80">
                         ...
                         <input 
                            ...
                            className="h-11 w-full rounded-xl border border-border bg-black/5 dark:bg-black/40 pl-11 pr-4 text-sm font-medium text-foreground focus:border-primary/50 focus:outline-none transition-all placeholder:text-muted-foreground shadow-inner"
                            value={searchQuery}
