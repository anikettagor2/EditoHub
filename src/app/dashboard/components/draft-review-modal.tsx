                        ...
                        {showFeedbackPopup && (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">Please provide feedback and rate this draft before downloading.</p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        placeholder="Share your thoughts about the draft. What's working well? Any suggestions for improvement?..."
                                        value={feedbackText}
